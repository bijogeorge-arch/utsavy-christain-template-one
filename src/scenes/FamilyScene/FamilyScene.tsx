    ...
    return (
        ...
        >
            <RightAlignedContent className="translate-y-0 sm:translate-y-[-2%]">
                ...
                <motion.h1
                    variants={itemVariants}
                    className="mt-2 font-[var(--font-display)] text-[clamp(2.8rem,10vw,4.4rem)] font-semibold leading-[0.88] tracking-[-0.07em] text-[var(--color-ivory-100)]"
                >
                    Family
                    <span className="block text-[var(--color-gold-300)]">Blessings</span>
                </motion.h1>

                <motion.p
                    variants={itemVariants}
                    className="mt-3.5 max-w-[280px] text-[13px] leading-relaxed text-[rgba(255,248,236,0.74)] sm:max-w-[300px]"
                >
                ...
                <motion.p
                    variants={itemVariants}
                    className="mt-4 max-w-[280px] text-[11px] leading-relaxed text-[rgba(255,248,236,0.64)]"
                >
