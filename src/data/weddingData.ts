...
export const weddingData: WeddingData = {
    ...
    bride: {
        ...
        portrait: "/placeholders/bride_portrait.png",
    },
    groom: {
        first: "Daniel",
        middle: "Varghese",
        ...
        portrait: "/placeholders/groom_portrait.png",
    },
    initials: "E & D",
    monogram: "ED",
    verse: {
    ...
    gallery: [
        {
            ...
            caption: "A graceful portrait of the bride, Elina.",
            src: "/placeholders/bride_portrait.png",
        },
        {
            id: "gallery-2",
            title: "Groom Portrait",
            caption: "A refined portrait of the groom, Daniel.",
            src: "/placeholders/groom_portrait.png",
        },
        {
            id: "gallery-3",
            title: "Together",
            caption: "Elina and Daniel in their sacred promise.",
            src: "/placeholders/couple_together.png",
        },
        {
            id: "gallery-4",
            title: "Family Blessing",
            caption: "Families united in prayer and blessing.",
            src: "/placeholders/family_portrait.png",
        },
    ],
    contacts: [
        {
